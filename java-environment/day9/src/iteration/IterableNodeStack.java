...
public class IterableNodeStack implements Iterable<Node> {
	...
	private class NodeIterator implements Iterator<Node> {
		// constructor for the NodeIterator
		NodeIterator() {
			cursor = top;
		}
...
/*
 * You may occasionally see classes defined in the same
 * file as another. Here, we do so since the Node class is
 * only used for the context of the IterableNodeStack
 */
class Node {
